  ...
  return (
    <div className="space-y-6">
      ...
      <ProfileCard
        ...
        location="Filamer Christian University, Inc."
        joinDate="September 2023"
        website="thehillsideecho.edu"
        email="jquitoy@filmer.edu.ph"
        followers={2847}
        following={523}
        posts={589}
      />
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="space-y-5">
            ...
            <div className="relative pl-6 border-l-2 border-gray-200 dark:border-gray-700">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                Graduated with Highest Honors. Editor-In-Chief of the school
                publication.
              </p>
            </div>
          </div>
          ...
          {[
            {
              ...
              detail: '"Tech Summit 2026: What to Expect"',
              time: '2 hours ago',
              type: 'publish',
            },
            {
              action: 'Reached milestone',
              detail: '2,500 followers on Instagram',
              time: '1 day ago',
              type: 'milestone',
            },
            {
              action: 'Edited article',
              detail: '"Student Council Elections Guide"',
              time: '2 days ago',
              type: 'edit',
            },
            {
              action: 'Scheduled post',
              detail: 'Campus event coverage for Friday',
              time: '3 days ago',
              type: 'schedule',
            },
            {
              action: 'Responded to comments',
              detail: '15 replies on Facebook post',
              time: '4 days ago',
              type: 'comment',
            },
          ].map((activity, i) => (
