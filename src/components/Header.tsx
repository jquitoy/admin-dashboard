...
export default function Header() {
  ...
  const notifications = [
    { id: 1, text: 'New article submission: "Campus Sustainability"', time: '5m ago', unread: true },
    { id: 2, text: 'Your post reached 500 engagements!', time: '1h ago', unread: true },
    { id: 3, text: 'Editor meeting tomorrow at 3 PM', time: '3h ago', unread: false },
  ];
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400">
              The Hillside Echo — Student Publication
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden sm:block">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">Editor-in-Chief</p>
            </div>
          </div>
        </div>
      </div>
